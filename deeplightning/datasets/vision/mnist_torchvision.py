"""This is a near-clone of the MNIST dataset from PyTorch with a simple
modification in `_load_data()` and `__getitem__()` to return the image path
along with the image (`data`) and label (`targets`).
<https://github.com/pytorch/vision/blob/v0.15.1/torchvision/datasets/mnist.py>
"""
import codecs
import os
import os.path
