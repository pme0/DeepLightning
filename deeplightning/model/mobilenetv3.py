...
from typing import Any, Dict, Callable, List, Optional, Sequence, Union, Tuple, TypeVar
...
def _mobilenet_v3(
    ...
    **kwargs: Any,
    ...
    model = MobileNetV3(inverted_residual_setting, last_channel, num_channels, num_classes, **kwargs)
