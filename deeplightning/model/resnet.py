...
def _resnet(arch, block, layers, num_channels, num_classes, pretrained, progress, device, **kwargs):
    model = ResNet(block, layers, num_channels, num_classes, **kwargs)
    if pretrained:
...
def resnet18(pretrained=False, progress=True, device="cpu", num_channels=3, num_classes=1000, **kwargs):
    ...
    """
    return _resnet(
        "resnet18", BasicBlock, [2, 2, 2, 2], num_channels, num_classes, pretrained, progress, device, **kwargs
    )
...
def resnet34(pretrained=False, progress=True, device="cpu", num_channels=3, num_classes=1000, **kwargs):
    ...
    """
    return _resnet(
        "resnet34", BasicBlock, [3, 4, 6, 3], num_channels, num_classes, 
...
def resnet50(pretrained=False, progress=True, device="cpu", num_channels=3, num_classes=1000, **kwargs):
    ...
    """
    return _resnet(
        "resnet50", Bottleneck, [3, 4, 6, 3], num_channels, num_classes, 
        pretrained, progress, device, **kwargs
    )
...
def resnet101(pretrained = False, progress = True, num_channels=3, num_classes=1000, **kwargs):
    ...
    """
    return _resnet(
        'resnet101', Bottleneck, [3, 4, 23, 3], num_channels, num_classes, 
...
def resnet152(pretrained = False, progress = True, num_channels=3, num_classes=1000, **kwargs):
    ...
    """
    return _resnet(
        "resnet152", Bottleneck, [3, 8, 36, 3], num_channels, num_classes, 
        pretrained, progress, **kwargs)
...
def resnext50_32x4d(pretrained = False, progress = True, num_channels=3, num_classes=1000, **kwargs):
    ...
    return _resnet(
        "resnext50_32x4d", Bottleneck, [3, 4, 6, 3], num_channels, num_classes, 
        pretrained, progress, **kwargs)
...
def resnext101_32x8d(pretrained = False, progress = True, num_channels=3, num_classes=1000, **kwargs):
    ...
    return _resnet(
        "resnext101_32x8d", Bottleneck, [3, 4, 23, 3], num_channels, num_classes, 
        pretrained, progress, **kwargs)
...
def wide_resnet50_2(pretrained = False, progress = True, num_channels=3, num_classes=1000, **kwargs):
    ...
    return _resnet(
        "wide_resnet50_2", Bottleneck, [3, 4, 6, 3], num_channels, num_classes, 
        pretrained, progress, **kwargs)
...
def wide_resnet101_2(pretrained = False, progress = True, num_channels=3, num_classes=1000, **kwargs):
    ...
    kwargs["width_per_group"] = 64 * 2
    return _resnet(
        "wide_resnet101_2", Bottleneck, [3, 4, 23, 3, num_channels, num_classes], 
        pretrained, progress, **kwargs)
