...
class ViT(nn.Module):
    ...
    dim : size of the patch embeddings
    ...
    pool : 
    dropout_attn : probability of dropout in the Attention layer
    dropout_emb : probability of dropout in the Embedding layer
    ...
    def __init__(self, *, 
        ...
        self.transformer = Transformer(dim, num_layers, num_heads, dim_head, mlp_dim, dropout_attn)
