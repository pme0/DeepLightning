...
def training_step_end__SemanticSegmentation(self):
...
def on_training_epoch_end__SemanticSegmentation(self):
    """ Hook for `on_training_epoch_end`.
    """
    pass


def validation_step__SemanticSegmentation(self, batch, batch_idx):
